...
- **13 languages:** English, हिन्दी, বাংলा, मराठी, ગુજરાતી, ਪੰਜਾਬੀ, ଓଡ଼ିଆ, தமிழ், తెలుగు, ಕನ್ನಡ, മലയാളം, اردو, অসমীয়া — via the globe button (🌐 Language) in the navbar. Choice is saved in the browser (localStorage). Urdu renders right-to-left automatically.
- No fabricated statistics or unverifiable claims — only service descriptions
